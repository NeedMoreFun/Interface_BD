...
function GetPageInfos()
{
    ...
    $result[] = array('caption' => 'Air Baloons', 'short_caption' => 'Air Baloons', 'filename' => 'air_baloons.php', 'name' => 'air_baloons', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Cars', 'short_caption' => 'Cars', 'filename' => 'cars.php', 'name' => 'cars', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Cars Driver', 'short_caption' => 'Cars Driver', 'filename' => 'cars_driver.php', 'name' => 'cars_driver', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Clients Pilots Air', 'short_caption' => 'Clients Pilots Air', 'filename' => 'clients_pilots_air.php', 'name' => 'clients_pilots_air', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    ...
    $result[] = array('caption' => 'Pilots', 'short_caption' => 'Pilots', 'filename' => 'pilots.php', 'name' => 'pilots', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
