 ...
 */
    ...
    class subjectsPage extends Page
    {
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_subject', 'id_subject', 'Id Subject'),
                new FilterColumn($this->dataset, 'subject_name', 'subject_name', 'Subject Name'),
        ...
        protected function setupQuickFilter(QuickFilter $quickFilter, FixedKeysArray $columns)
        {
            $quickFilter
                ...
                ->addColumn($columns['subject_name'])
        ...
        {
            //
            // View column for id_subject field
            //
            $column = new NumberViewColumn('id_subject', 'id_subject', 'Id Subject', $this->dataset);
            ...
            //
            $column = new TextViewColumn('subject_name', 'subject_name', 'Subject Name', $this->dataset);
            $column->SetOrderable(true);
        ...
        {
            //
            // Edit column for subject_name field
            //
            $editor = new TextEdit('subject_name_edit');
            $editor->SetMaxLength(100);
            $editColumn = new CustomEditColumn('Subject Name', 'subject_name', $editor, $this->dataset);
    ...
    try
    {
        $Page = new subjectsPage("subjects", "subjects.php", GetCurrentUserPermissionsForPage("subjects"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("subjects"));
