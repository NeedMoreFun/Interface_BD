 ...
 */
    ...
    class hallsPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Halls');
            $this->SetMenuLabel('Halls');
            ...
            $this->dataset->AddLookupField('id_hall', 'sessions', new IntegerField('id_hall'), new IntegerField('id_film', false, false, false, false, 'id_hall_id_film', 'id_hall_id_film_sessions'), 'id_hall_id_film_sessions');
        }
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_hall', 'id_hall_id_film', 'Id Hall'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            $column = new NumberViewColumn('id_hall', 'id_hall_id_film', 'Id Hall', $this->dataset);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            $lookupDataset->setOrderByField('id_film', 'ASC');
            $editColumn = new LookUpEditColumn(
                'Id Hall', 
                'id_hall', 
                $editor, 
                $this->dataset, 'id_hall', 'id_film', $lookupDataset);
    ...
    try
    {
        $Page = new hallsPage("halls", "halls.php", GetCurrentUserPermissionsForPage("halls"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("halls"));
