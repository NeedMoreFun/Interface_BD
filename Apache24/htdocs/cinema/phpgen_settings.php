...
{
    $result = array();
    $result[] = array('caption' => 'Category Of Places', 'short_caption' => 'Category Of Places', 'filename' => 'category_of_places.php', 'name' => 'category_of_places', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Clients', 'short_caption' => 'Clients', 'filename' => 'clients.php', 'name' => 'clients', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Films', 'short_caption' => 'Films', 'filename' => 'films.php', 'name' => 'films', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Halls', 'short_caption' => 'Halls', 'filename' => 'halls.php', 'name' => 'halls', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Places And Rows', 'short_caption' => 'Places And Rows', 'filename' => 'places_and_rows.php', 'name' => 'places_and_rows', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Price', 'short_caption' => 'Price', 'filename' => 'price.php', 'name' => 'price', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Sessions', 'short_caption' => 'Sessions', 'filename' => 'sessions.php', 'name' => 'sessions', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Tickets', 'short_caption' => 'Tickets', 'filename' => 'tickets.php', 'name' => 'tickets', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
