 ...
 */
    ...
    class pricePage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('id_category', true, true),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_category', 'id_category', 'Id Category'),
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            $editor = new TextEdit('id_category_edit');
            $editColumn = new CustomEditColumn('Id Category', 'id_category', $editor, $this->dataset);
    ...
    try
    {
        $Page = new pricePage("price", "price.php", GetCurrentUserPermissionsForPage("price"), 'UTF-8');
